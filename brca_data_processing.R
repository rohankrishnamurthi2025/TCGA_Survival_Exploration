...
# Read in data
clinical_nte_brca <- read.csv("data/clinical_nte_brca.csv", header = TRUE)
clinical_follow_up_v4.0_nte_brca <- read.csv("data/clinical_follow_up_v4.0_nte_brca.csv", header = TRUE)
clinical_drug_brca <- read.csv("data/clinical_drug_brca.csv", header = TRUE)
clinical_follow_up_v1.5_brca <- read.csv("data/clinical_follow_up_v1.5_brca.csv", header = TRUE)
clinical_follow_up_v4.0_brca <- read.csv("data/clinical_follow_up_v4.0_brca.csv", header = TRUE)
clinical_radiation_brca <- read.csv("data/clinical_radiation_brca.csv", header = TRUE)
clinical_follow_up_v2.1_brca <- read.csv("data/clinical_follow_up_v2.1_brca.csv", header = TRUE)
clinical_patient_brca <- read.csv("data/clinical_patient_brca.csv", header = TRUE)
clinical_omf_v4.0_brca <- read.csv("data/clinical_omf_v4.0_brca.csv", header = TRUE)
...
patient_data <- clinical_patient_brca
...
brca_patient_data_processed <- patient_data
...
write.csv(brca_patient_data_processed, file = "data/brca_patient_data_processed.csv", row.names = FALSE)
